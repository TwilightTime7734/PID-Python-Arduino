...
CHANNEL_DEFAULTS = [1500, 1500, 1250, 1500]
OFFSET_DEFAULTS = [-4, -2, -3, 6]
PPM_OUTPUT_CHANNEL_COUNT = 8
PID_TEST_CH8_CHANNEL_INDEX = 7
PID_TEST_CH8_OFF_US = 1000
PID_TEST_CH8_ON_US = 2000
PID_TEST_CH8_SPINUP_DELAY_MS = 2000
PID_PLAN_FLY_LOG_RUNTIME_S = 30.0
FLY_LOG_SAFETY_TIMEOUT_S = 120.0
ARDUINO_FIXED_PULSE_HOLD_S = 0.10
ARDUINO_FIXED_PULSE_HOLD_MS = 100
...
PULSE_COMMAND_START_FIXED = 1
PULSE_COMMAND_CANCEL = 2
